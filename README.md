...
- 💬 **Chat en tiempo real** con respuestas de IA usando Google Gemini API
- 🎨 **Interfaz moderna** con TailwindCSS y componentes responsivos  
- 📝 **Renderizado de Markdown** con soporte para headers y bloques de código
- 🔧 **Syntax highlighting** automático para múltiples lenguajes de programación
- 📱 **Diseño responsive** optimizado para desktop y móvil
- 🔄 **Reintentar mensajes** fácilmente con botones de acción
